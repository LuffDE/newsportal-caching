...
class Category
{
     ...
     */
    #[ORM\OneToMany(targetEntity: UserCategoryPreference::class, mappedBy: 'category', orphanRemoval: true)]
    ...
    public function addUserCategoryPreference(UserCategoryPreference $userCategoryPreference): static
    {
        if (!$this->userCategoryPreferences->contains($userCategoryPreference)) {
            ...
            $userCategoryPreference->setCategory($this);
        }
    ...
    {
        if ($this->userCategoryPreferences->removeElement($userCategoryPreference) && $userCategoryPreference->getCategory() === $this) {
            $userCategoryPreference->setCategory(null);
        }
